...
This document describes our Bayesian penetrance estimation protocol for the KCNQ1-LQT1 genotype-phenotype relationship. We integrate variant-specific features to develop a prior probability of LQT1 manifestation. We update this prior using clinical phenotype counts from variant heterozygotes and population controls to yield a posterior. We evaluate our method using Spearman and Pearson correlations, Brier Scores, and 10-fold cross validation. This work builds on previously published work for SCN5A (PMID: 32569262) and KCNH2 (PMID: 34309407). 
...
# Penetrance estimate by Residue - Supplemental Figure 1 
...
# Plot penetrance density by residue - Supplemental Figure 1 
...
# 10-fold Crossfold Validation for Spearman, Pearson, and Brier scores 

## Import Data 

```{r cars}

# Works with previous version - optimize on below


#load("lit_plus_cohort_checkpoint_prospective_v2.RData") 

# overlap of variants - remove non-unqiues
