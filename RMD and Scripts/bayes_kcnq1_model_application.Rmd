...
load('~/Desktop/Bayes_Incomplete_Penetrance/RMD and Scripts/KCNQ1_prepared_data') 

# Include distances between residue centroids from structure of KCNQ1 PDB-ID: 6UZZ
q1dist <- read.csv(file = '~/Desktop/Bayes_Incomplete_Penetrance/Covariates/kcnq1_distances.csv', header = FALSE)
...
rm(d)
load('~/Desktop/Bayes_Incomplete_Penetrance/RMD and Scripts/lit_plus_cohort_checkpoint_application.RData')
...
annotation <- read.csv('~/Desktop/Bayes_Incomplete_Penetrance/Heterozygote Data/KCNQ1_clinvar.csv', header = TRUE)
