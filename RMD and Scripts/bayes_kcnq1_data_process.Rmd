...
setwd('/Users/mattoneill/Desktop/Bayes_Incomplete_Penetrance/')
source('~/Desktop/Bayes_Incomplete_Penetrance/RMD and Scripts/func_dist_seq.R')
...
load('~/Desktop/Bayes_Incomplete_Penetrance/Heterozygote Data/LitFinal_v7.RData')
...
japan.data <- read.csv('~/Desktop/Bayes_Incomplete_Penetrance/Heterozygote Data/Japan_cohort-v1.csv')

load('~/Desktop/Bayes_Incomplete_Penetrance/Heterozygote Data/KCNQ1_Italy_v3.RData')
italy.data <- italy_final

load('~/Desktop/Bayes_Incomplete_Penetrance/Heterozygote Data/KCNQ1_Paris_v2.RData')
...
cb<-read.table('~/Desktop/Bayes_Incomplete_Penetrance/Covariates/cardiacboost_arm_all_possible_mutations-adj.csv', sep = "\t", header = TRUE)
cb<-cb[cb$gene=="KCNQ1",]
...
pssm<-read.table('~/Desktop/Bayes_Incomplete_Penetrance/Covariates/EMBL_EBI_KCNQ1_PSSM.txt', sep = "", header = TRUE)
...
pph2<-read.csv('~/Desktop/Bayes_Incomplete_Penetrance/Covariates/pph2-full_kcnq1.txt', sep = '\t', strip.white = TRUE)
...
prov_kcnq1 <- read.table('~/Desktop/Bayes_Incomplete_Penetrance/Covariates/Provean_and_SIFT_KCNQ1.tsv', sep = '\t', header = FALSE)
...
load('~/Desktop/Bayes_Incomplete_Penetrance/Covariates/revel.RData')
revel <- revel_kcnq1
...
q1.function <- read.csv("data/Covariates/KCNQ1_functional_data_trimmed_v2.csv", header=TRUE, stringsAsFactors=FALSE)

# make numeric here

#q1.function <- lapply(q1.function[,2:9], as.numeric)
...
#q1.covariates <- q1.covariates[!is.na(q1.covariates$revel_score), ]

save(cohort.data, q1.covariates, lit.cohort.data, lit.nonoverlap.data, mut_type, file="KCNQ1_prepared_v16.RData")
